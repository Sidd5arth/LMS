...
const Dashboard = () => {
  ...
  return (
    <div>
      <Navbar />
      {pageData ? <div className="flex justify-center align-middle">No History, Plaese Enroll in a course</div> :<>
      {isloading || userCourseData === null ? <div className="flex justify-center align-middle">Loading enrolled Courses...</div>
      :<div className="p-12">
        ...
        <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {userCourseData?.map((course) => (
            <li key={course.id} className="border border-black rounded-md p-4">
              {/* <img
